...
add_shortcode('gallery', 'nmi_gallery');

function nmi_gallery($attr) {
	$post = get_post();
	...
	$gallery_div = "<div id='$selector' class='thumbnails gallery galleryid-{$id} gallery-columns-{$columns} gallery-size-{$size_class}'>";
...
// Thumbnail sizes
add_image_size( 'full', 940, 240, true );
add_image_size( 'showcase', 220, 140, true );
/* 
